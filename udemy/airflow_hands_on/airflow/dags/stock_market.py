...
def stock_market():
    ...
    def is_api_available() -> PokeReturnValue:
        import requests
        # Note: to test this task run
        # astro dev run tasks test stock_market is_api_available 2025-01-01

        # Hooks are used to interact with outside services/apps
    ...
    # note: PythonOperator used instead of taskflow decorator to prevent potential 
    # conflict with Docker Spark Operator
    ...
    # To test get_stock_prices, create task dependencies first then run
